let spans = document.querySelectorAll(".container h1 > span");

let textArry = ["first", "attempt", "in", "learning"];

spans.forEach((letter, i) => {
    letter.onmouseover = () => {
        setTimeout(() => {
            letter.classList.add("__blank");
            letter.innerText = textArry[i];
        }, 200);
    };
